  ...
  <div :class="$style.container">
    ...
    <div :class="$style.main" ref="mainNode">
      <div :class="$style.wrapper" :style="{ width }">
        <img :class="$style.image" ref="imgNode" :src="`./assets/${images[`./assets/${cArr[count].code.toLocaleLowerCase()}.svg`].name}`" alt="" />
      </div>
    </div>
...
// console.log(images);
// countries.map(item => {
//   item.flag = images[`./svg/${item.code.toLocaleLowerCase()}.svg`].name
// })
